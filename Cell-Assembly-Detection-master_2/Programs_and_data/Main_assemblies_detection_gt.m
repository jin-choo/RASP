function [assembly]=Main_assemblies_detection_gt(spM,MaxLags,BinSizes,ref_lag,alph,No_th,O_th,bytelimit,outputprint,filepathprint,RecordingTime,seed)
...
parfor gg=1:length(BinSizes)
    ...
    if size(binM,2)-MaxLags(gg)<100
        ...
        fprintf(fileID, outputprint + ',%d,%d,%.2f,%d,%d,%d\n', int * 1000, maxlag, alph, O_th, RunningTime, seed); 
        fclose(fileID);
%         end
    end
end
