...
for iMotifType=1:length(MotifTypeMotifMaxs)
    ...
    fileID = fopen(sprintf('/home/dmlab/hyunjin/brainimage/cad_stat2/%d_time_%s.csv', MotifType, datestr(starttime, 'mm.dd_HH.MM')),'w');
...
parfor iTable=1:height(Table)
    ...
    MotifTypeprint = sprintf("/home/dmlab/hyunjin/brainimage/cad_stat2/%d_time_%s.csv", MotifType, datestr(starttime, 'mm.dd_HH.MM'));
