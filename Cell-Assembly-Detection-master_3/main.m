...
RecordingTimes = [10];  %1000 500 100 50 
NIDsMotifNeuronsNumbers = ["10000505"];  %, "05000505", "03000505", "02000505"
%"0500505" "1000510" "1000505" "0750505" "0250505" "0500305" "0500405" "0500605" "0500705"
...
for iMotifType=1:length(MotifTypeMotifMaxs)
    ...
    fileID = fopen(sprintf('/home/dmlab/hyunjin/brainimage/cad_stat3/%d_time_%s.csv', MotifType, datestr(starttime, 'mm.dd_HH.MM')),'w');
...
parfor iTable=1:height(Table)
    ...
    MotifTypeprint = sprintf("/home/dmlab/hyunjin/brainimage/cad_stat3/%d_time_%s.csv", MotifType, datestr(starttime, 'mm.dd_HH.MM'));
