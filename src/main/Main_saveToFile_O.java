...
public class Main_saveToFile_O {
...
//		add(new int[]{50, 3, 5}); add(new int[]{50, 7, 5});
...
//		add(new int[]{50, 4, 5}); add(new int[]{50, 6, 5});
		...
		for (int[] motifTypeMax : motifTypeMaxList) {
			BufferedWriter writerTime = new BufferedWriter(new FileWriter(String.format("./txt/%d_tree_tid_over_time_%s.csv", motifTypeMax[0], new SimpleDateFormat("MM.dd_HH.mm").format(timestamp))));
